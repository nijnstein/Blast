...
namespace NSS.Blast.External
{
 ...
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate void BlastEFDelegate([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float2* BlastEFDelegate_F2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float2* result);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float3* BlastEFDelegate_F3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float3* result);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float4* BlastEFDelegate_F4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float4* result);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int BlastEFDelegate_I1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int2* BlastEFDelegate_I2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]int2* result);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int3* BlastEFDelegate_I3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]int3* result);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int4* BlastEFDelegate_I4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]int4* result);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BlastEFDelegate_B32([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]Bool32* result);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, float p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f1f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, float p0, float p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f1f1f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, float p0, float p1, float p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f1f1f1f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, float p0, float p1, float p2, float p3);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f1f1f1f1f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, float p0, float p1, float p2, float p3, float p4);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f1f1f1f1f1f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, float p0, float p1, float p2, float p3, float p4, float p5);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f1f1f1f1f1f1f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, float p0, float p1, float p2, float p3, float p4, float p5, float p6);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f1f1f1f1f1f1f1f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float2* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f2f2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float2* p0, [NoAlias]float2* p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f2f2f2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float2* p0, [NoAlias]float2* p1, [NoAlias]float2* p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float3* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f3f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float3* p0, [NoAlias]float3* p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f3f3f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float3* p0, [NoAlias]float3* p1, [NoAlias]float3* p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float4* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f4f4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float4* p0, [NoAlias]float4* p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BlastEFDelegate_F1_f4f4f4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float4* p0, [NoAlias]float4* p1, [NoAlias]float4* p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float2* BlastEFDelegate_F2_f2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float2* result, [NoAlias]float2* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float2* BlastEFDelegate_F2_f2f2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float2* result, [NoAlias]float2* p0, [NoAlias]float2* p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float2* BlastEFDelegate_F2_f2f2f2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float2* result, [NoAlias]float2* p0, [NoAlias]float2* p1, [NoAlias]float2* p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float3* BlastEFDelegate_F3_f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float3* result, [NoAlias]float3* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float3* BlastEFDelegate_F3_f3f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float3* result, [NoAlias]float3* p0, [NoAlias]float3* p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float3* BlastEFDelegate_F3_f3f3f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float3* result, [NoAlias]float3* p0, [NoAlias]float3* p1, [NoAlias]float3* p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float4* BlastEFDelegate_F4_f4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float4* result, [NoAlias]float4* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float4* BlastEFDelegate_F4_f4f4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float4* result, [NoAlias]float4* p0, [NoAlias]float4* p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float4* BlastEFDelegate_F4_f4f4f4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]float4* result, [NoAlias]float4* p0, [NoAlias]float4* p1, [NoAlias]float4* p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate void BlastEFDelegate_b32([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]Bool32* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BlastEFDelegate_B32_b32([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]Bool32* result, [NoAlias]Bool32* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BlastEFDelegate_B32_b32f4f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]Bool32* result, [NoAlias]Bool32* p0, [NoAlias]float4* p1, float p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate void BlastEFDelegate_i1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, int p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int BlastEFDelegate_I1_i1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, int p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int BlastEFDelegate_I1_i1i1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, int p0, int p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int BlastEFDelegate_I1_i1i1i1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, int p0, int p1, int p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int BlastEFDelegate_I1_i1f3f3f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, int p0, [NoAlias]float3* p1, [NoAlias]float3* p2, [NoAlias]float3* p3);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int BlastEFDelegate_I1_i1f3f4f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, int p0, [NoAlias]float3* p1, [NoAlias]float4* p2, [NoAlias]float3* p3);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BlastEFDelegate_B32_i1f3f3f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]Bool32* result, int p0, [NoAlias]float3* p1, [NoAlias]float3* p2, [NoAlias]float3* p3);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BlastEFDelegate_B32_i1f3f4f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]IntPtr caller, [NoAlias]Bool32* result, int p0, [NoAlias]float3* p1, [NoAlias]float4* p2, [NoAlias]float3* p3);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate void BSEFDelegate();
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1();
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float2* BSEFDelegate_F2([NoAlias]float2* result);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float3* BSEFDelegate_F3([NoAlias]float3* result);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float4* BSEFDelegate_F4([NoAlias]float4* result);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BSEFDelegate_B32([NoAlias]Bool32* result);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f1(float p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f1f1(float p0, float p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f1f1f1(float p0, float p1, float p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f1f1f1f1(float p0, float p1, float p2, float p3);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f1f1f1f1f1(float p0, float p1, float p2, float p3, float p4);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f1f1f1f1f1f1(float p0, float p1, float p2, float p3, float p4, float p5);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f1f1f1f1f1f1f1(float p0, float p1, float p2, float p3, float p4, float p5, float p6);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f1f1f1f1f1f1f1f1(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f2([NoAlias]float2* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f2f2([NoAlias]float2* p0, [NoAlias]float2* p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f2f2f2([NoAlias]float2* p0, [NoAlias]float2* p1, [NoAlias]float2* p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f3([NoAlias]float3* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f3f3([NoAlias]float3* p0, [NoAlias]float3* p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f3f3f3([NoAlias]float3* p0, [NoAlias]float3* p1, [NoAlias]float3* p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f4([NoAlias]float4* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f4f4([NoAlias]float4* p0, [NoAlias]float4* p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float BSEFDelegate_F1_f4f4f4([NoAlias]float4* p0, [NoAlias]float4* p1, [NoAlias]float4* p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float2* BSEFDelegate_F2_f2([NoAlias]float2* result, [NoAlias]float2* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float2* BSEFDelegate_F2_f2f2([NoAlias]float2* result, [NoAlias]float2* p0, [NoAlias]float2* p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float2* BSEFDelegate_F2_f2f2f2([NoAlias]float2* result, [NoAlias]float2* p0, [NoAlias]float2* p1, [NoAlias]float2* p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float3* BSEFDelegate_F3_f3([NoAlias]float3* result, [NoAlias]float3* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float3* BSEFDelegate_F3_f3f3([NoAlias]float3* result, [NoAlias]float3* p0, [NoAlias]float3* p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float3* BSEFDelegate_F3_f3f3f3([NoAlias]float3* result, [NoAlias]float3* p0, [NoAlias]float3* p1, [NoAlias]float3* p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float4* BSEFDelegate_F4_f4([NoAlias]float4* result, [NoAlias]float4* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float4* BSEFDelegate_F4_f4f4([NoAlias]float4* result, [NoAlias]float4* p0, [NoAlias]float4* p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float4* BSEFDelegate_F4_f4f4f4([NoAlias]float4* result, [NoAlias]float4* p0, [NoAlias]float4* p1, [NoAlias]float4* p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate void BSEFDelegate_b32([NoAlias]Bool32* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BSEFDelegate_B32_b32([NoAlias]Bool32* result, [NoAlias]Bool32* p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BSEFDelegate_B32_b32f4f1([NoAlias]Bool32* result, [NoAlias]Bool32* p0, [NoAlias]float4* p1, float p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate void BSEFDelegate_i1(int p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int BSEFDelegate_I1_i1(int p0);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int BSEFDelegate_I1_i1i1(int p0, int p1);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int BSEFDelegate_I1_i1i1i1(int p0, int p1, int p2);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int BSEFDelegate_I1_i1f3f3f3(int p0, [NoAlias]float3* p1, [NoAlias]float3* p2, [NoAlias]float3* p3);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate int BSEFDelegate_I1_i1f3f4f3(int p0, [NoAlias]float3* p1, [NoAlias]float4* p2, [NoAlias]float3* p3);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BSEFDelegate_B32_i1f3f3f3([NoAlias]Bool32* result, int p0, [NoAlias]float3* p1, [NoAlias]float3* p2, [NoAlias]float3* p3);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BSEFDelegate_B32_i1f3f4f3([NoAlias]Bool32* result, int p0, [NoAlias]float3* p1, [NoAlias]float4* p2, [NoAlias]float3* p3);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate void* BlastEFSSMDDelegate([NoAlias]IntPtr engine, [NoAlias]IntPtr data);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float2* BlastEFSSMDDelegate_F2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float2* result, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float3* BlastEFSSMDDelegate_F3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float3* result, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float4* BlastEFSSMDDelegate_F4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float4* result, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BlastEFSSMDDelegate_B32([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]Bool32* result, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float* p0, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f1f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float* p0, [NoAlias]float* p1, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f1f1f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float* p0, [NoAlias]float* p1, [NoAlias]float* p2, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f1f1f1f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float* p0, [NoAlias]float* p1, [NoAlias]float* p2, [NoAlias]float* p3, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f1f1f1f1f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float* p0, [NoAlias]float* p1, [NoAlias]float* p2, [NoAlias]float* p3, [NoAlias]float* p4, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f1f1f1f1f1f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float* p0, [NoAlias]float* p1, [NoAlias]float* p2, [NoAlias]float* p3, [NoAlias]float* p4, [NoAlias]float* p5, int ssmd_datacount);
 ...
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float2* p0, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f2f2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float2* p0, [NoAlias]float2* p1, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f2f2f2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float2* p0, [NoAlias]float2* p1, [NoAlias]float2* p2, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float3* p0, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f3f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float3* p0, [NoAlias]float3* p1, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f3f3f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float3* p0, [NoAlias]float3* p1, [NoAlias]float3* p2, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float4* p0, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f4f4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float4* p0, [NoAlias]float4* p1, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float* BlastEFSSMDDelegate_F1_f4f4f4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float* result, [NoAlias]float4* p0, [NoAlias]float4* p1, [NoAlias]float4* p2, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float2* BlastEFSSMDDelegate_F2_f2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float2* result, [NoAlias]float2* p0, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float2* BlastEFSSMDDelegate_F2_f2f2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float2* result, [NoAlias]float2* p0, [NoAlias]float2* p1, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float2* BlastEFSSMDDelegate_F2_f2f2f2([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float2* result, [NoAlias]float2* p0, [NoAlias]float2* p1, [NoAlias]float2* p2, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float3* BlastEFSSMDDelegate_F3_f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float3* result, [NoAlias]float3* p0, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float3* BlastEFSSMDDelegate_F3_f3f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float3* result, [NoAlias]float3* p0, [NoAlias]float3* p1, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float3* BlastEFSSMDDelegate_F3_f3f3f3([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float3* result, [NoAlias]float3* p0, [NoAlias]float3* p1, [NoAlias]float3* p2, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float4* BlastEFSSMDDelegate_F4_f4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float4* result, [NoAlias]float4* p0, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float4* BlastEFSSMDDelegate_F4_f4f4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float4* result, [NoAlias]float4* p0, [NoAlias]float4* p1, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate float4* BlastEFSSMDDelegate_F4_f4f4f4([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]float4* result, [NoAlias]float4* p0, [NoAlias]float4* p1, [NoAlias]float4* p2, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate void* BlastEFSSMDDelegate_b32([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]Bool32* p0, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BlastEFSSMDDelegate_B32_b32([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]Bool32* result, [NoAlias]Bool32* p0, int ssmd_datacount);
 [UnmanagedFunctionPointer(CallingConvention.Cdecl)] unsafe public delegate Bool32* BlastEFSSMDDelegate_B32_b32f4f1([NoAlias]IntPtr engine, [NoAlias]IntPtr data, [NoAlias]Bool32* result, [NoAlias]Bool32* p0, [NoAlias]float4* p1, [NoAlias]float* p2, int ssmd_datacount);
