    ...
    unsafe public partial struct BlastInterpretor
    {
        ...
        void CALL_FN_CEILLOG2(ref int code_pointer, ref V4 v4, out byte vector_size, out BlastVariableDataType datatype)
        {
            ...
            switch (datatype.Combine(vector_size, is_negated))
            {
                ...
                case BlastVectorType.float1: v4.x     =  math.ceillog2((int)((float*)fdata)[0]);   break;
                case BlastVectorType.float2: v4.xy    =  math.ceillog2((int2)((float2*)fdata)[0]); break;
                case BlastVectorType.float3: v4.xyz   =  math.ceillog2((int3)((float3*)fdata)[0]); break;
                case BlastVectorType.float4: v4       =  math.ceillog2((int4)((float4*)fdata)[0]); break;
                ...
                case BlastVectorType.float1_n: v4.x   = -math.ceillog2((int)((float*)fdata)[0]);   break;
                case BlastVectorType.float2_n: v4.xy  = -math.ceillog2((int2)((float2*)fdata)[0]); break;
                case BlastVectorType.float3_n: v4.xyz = -math.ceillog2((int3)((float3*)fdata)[0]); break;
                case BlastVectorType.float4_n: v4     = -math.ceillog2((int4)((float4*)fdata)[0]); break;
        ...
        void CALL_FN_CEILPOW2(ref int code_pointer, ref V4 v4, out byte vector_size, out BlastVariableDataType datatype)
        {
            ...
            switch (datatype.Combine(vector_size, is_negated))
            {
                ...
                case BlastVectorType.float1: v4.x     =  math.ceilpow2((int)((float*)fdata)[0]);   break;
                case BlastVectorType.float2: v4.xy    =  math.ceilpow2((int2)((float2*)fdata)[0]); break;
                case BlastVectorType.float3: v4.xyz   =  math.ceilpow2((int3)((float3*)fdata)[0]); break;
                case BlastVectorType.float4: v4       =  math.ceilpow2((int4)((float4*)fdata)[0]); break;
                ...
                case BlastVectorType.float1_n: v4.x   = -math.ceilpow2((int)((float*)fdata)[0]);   break;
                case BlastVectorType.float2_n: v4.xy  = -math.ceilpow2((int2)((float2*)fdata)[0]); break;
                case BlastVectorType.float3_n: v4.xyz = -math.ceilpow2((int3)((float3*)fdata)[0]); break;
                case BlastVectorType.float4_n: v4     = -math.ceilpow2((int4)((float4*)fdata)[0]); break;
        ...
        void CALL_FN_FLOORLOG2(ref int code_pointer, ref V4 v4, out byte vector_size, out BlastVariableDataType datatype)
        {
            ...
            switch (datatype.Combine(vector_size, is_negated))
            {
                ...
                case BlastVectorType.float1: v4.x     =  math.floorlog2((int)((float*)fdata)[0]);   break;
                case BlastVectorType.float2: v4.xy    =  math.floorlog2((int2)((float2*)fdata)[0]); break;
                case BlastVectorType.float3: v4.xyz   =  math.floorlog2((int3)((float3*)fdata)[0]); break;
                case BlastVectorType.float4: v4       =  math.floorlog2((int4)((float4*)fdata)[0]); break;
                ...
                case BlastVectorType.float1_n: v4.x   = -math.floorlog2((int)((float*)fdata)[0]);   break;
                case BlastVectorType.float2_n: v4.xy  = -math.floorlog2((int2)((float2*)fdata)[0]); break;
                case BlastVectorType.float3_n: v4.xyz = -math.floorlog2((int3)((float3*)fdata)[0]); break;
                case BlastVectorType.float4_n: v4     = -math.floorlog2((int4)((float4*)fdata)[0]); break;
