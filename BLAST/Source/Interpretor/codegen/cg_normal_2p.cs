...
namespace NSS.Blast.Interpretor
{
    unsafe public partial struct BlastInterpretor
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        void CALL_FN_LOOKROTATION(ref int code_pointer, ref V4 v4, out byte vector_size, out BlastVariableDataType datatype)
        {
            code_pointer += 1;
            void* fdata = (void*)pop_p_info(ref code_pointer, out datatype, out vector_size, out bool is_negated);
            ...
            switch (datatype.Combine(vector_size, is_negated))
            {
                case BlastVectorType.float3: v4     = quaternion.LookRotation(((float3*)fdata)[0], pop_as_f3(ref code_pointer)).value; break;
                case BlastVectorType.int3: v4       = quaternion.LookRotation(((int3*)fdata)[0], pop_as_i1(ref code_pointer)).value; break;
                case BlastVectorType.float3_n: v4   = quaternion.LookRotation(-((float3*)fdata)[0], pop_as_f3(ref code_pointer)).value; break;
                case BlastVectorType.int3_n: v4     = quaternion.LookRotation(-((int3*)fdata)[0], pop_as_i3(ref code_pointer)).value; break;

#if DEVELOPMENT_BUILD || TRACE
                default:
                    {
                        Debug.LogError($"Blast.Interpretor.LOOKROTATION: vectorsize {vector_size}, datatype {datatype} not supported");
                        break;
                    }
#endif
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        void CALL_FN_LOOKROTATIONSAFE(ref int code_pointer, ref V4 v4, out byte vector_size, out BlastVariableDataType datatype)
        {
            code_pointer += 1;
            void* fdata = (void*)pop_p_info(ref code_pointer, out datatype, out vector_size, out bool is_negated);
            ...
            switch (datatype.Combine(vector_size, is_negated))
            {
                case BlastVectorType.float3: v4     = quaternion.LookRotationSafe(((float3*)fdata)[0], pop_as_f3(ref code_pointer)).value; break;
                case BlastVectorType.int3: v4       = quaternion.LookRotationSafe(((int3*)fdata)[0], pop_as_i1(ref code_pointer)).value; break;
                case BlastVectorType.float3_n: v4   = quaternion.LookRotationSafe(-((float3*)fdata)[0], pop_as_f3(ref code_pointer)).value; break;
                case BlastVectorType.int3_n: v4     = quaternion.LookRotationSafe(-((int3*)fdata)[0], pop_as_i3(ref code_pointer)).value; break;

#if DEVELOPMENT_BUILD || TRACE
                default:
                    {
                        Debug.LogError($"Blast.Interpretor.LOOKROTATIONSAFE: vectorsize {vector_size}, datatype {datatype} not supported");
                        break;
                    }
#endif
            }
