...
namespace NSS.Blast.SSMD
{
    unsafe public partial struct simd
    {
        ...
        #region sub_array_fxfx
        /// <summary>
        /// a.xyzw = a.xyzw - b.x
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f4f1([NoAlias] float4* a, [NoAlias] float4* b, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f4f1([NoAlias] float4* a, in float constant, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f4f4([NoAlias] float4* a, [NoAlias] float4* b, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f3f1([NoAlias] float4* a, [NoAlias] float4* b, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f3f1([NoAlias] float4* a, in float constant, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f3f3([NoAlias] float4* a, [NoAlias] float4* b, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f2f1([NoAlias] float4* a, [NoAlias] float4* b, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f2f1([NoAlias] float4* a, in float constant, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f2f2([NoAlias] float4* a, [NoAlias] float4* b, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f1f2([NoAlias] float4* a, [NoAlias] float4* b, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f1f3([NoAlias] float4* a, [NoAlias] float4* b, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f1f4([NoAlias] float4* a, [NoAlias] float4* b, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f1f1([NoAlias] float4* a, [NoAlias] float4* b, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f1f1([NoAlias] float4* a, in float constant, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        static public void sub_array_f1f1_indexed<T>([NoAlias] T* fn_out, [NoAlias] float* f1_in, [NoAlias] float** indexed_data, in int data_offset, in bool is_aligned, in int data_rowsize, in int ssmd_datacount) where T : unmanaged
        {
        ...
        /// </summary>
        static public void sub_array_f2f2_indexed<T>([NoAlias] T* fn_out, [NoAlias] float2* f2_in, [NoAlias] float** indexed_data, in int data_offset, in bool is_aligned, in int data_rowsize, in int ssmd_datacount) where T : unmanaged
        {
            float* p_out = (float*)(void*)fn_out;
        ...
        /// </summary>        
        static public void sub_array_f3f3_indexed<T>([NoAlias] T* fn_out, [NoAlias] float3* f3_in, [NoAlias] float** indexed_data, in int data_offset, in bool is_aligned, in int data_rowsize, in int ssmd_datacount) where T : unmanaged
        {
            float* p_out = (float*)(void*)fn_out;
        ...
        static public void sub_array_f4f4_indexed([NoAlias] float4* f4_out, [NoAlias] float4* f4_in, [NoAlias] float** indexed_data, in int data_offset, in bool is_aligned, in int data_rowsize, in int ssmd_datacount)
        {
        ...
        #region sub_array_fxfx_constant

        /// <summary>
        /// f4_out[i] = f4_in[i] - constant
        /// </summary>
        static public void sub_array_f4f4_constant([NoAlias] float4* f4_out, [NoAlias] float4* f4_in, float constant, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* p_out = (float*)(void*)f4_out;
        ...
        /// </summary>
        static public void sub_array_f14f1_constant([NoAlias] float4* f4_out, [NoAlias] float* f1_in, float constant, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* p_out = (float*)(void*)f4_out;
        ...
        /// </summary>
        static public void sub_array_f3f3_constant([NoAlias] float3* f3_out, [NoAlias] float3* f3_in, float constant, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
        ...
        /// </summary>
        static public void sub_array_f3f3_constant([NoAlias] float4* f4_out, [NoAlias] float3* f3_in, float constant, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* p_out = (float*)(void*)f4_out;
        ...
        /// </summary>
        static public void sub_array_f2f2_constant([NoAlias] float2* f2_out, [NoAlias] float2* f2_in, float constant, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
        ...
        /// </summary>
        static public void sub_array_f2f2_constant([NoAlias] float4* f4_out, [NoAlias] float2* f2_in, float constant, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* p_out = (float*)(void*)f4_out;
        ...
        /// </summary>
        static public void sub_array_f1f1_constant([NoAlias] float* f1_out, [NoAlias] float* f1_in, float constant, in int ssmd_datacount)
        {
            if (IsUnrolled)
            {
                float* p_out = f1_out;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f2f2([NoAlias] float4* a, [NoAlias] float4* b, in DATAREC target, in int ssmd_datacount)
        {
            if (target.is_aligned)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f3f3([NoAlias] float4* a, [NoAlias] float4* b, in DATAREC target, in int ssmd_datacount)
        {
            if (target.is_aligned)
            {
                float* fa = (float*)(void*)a;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f4f4([NoAlias] float4* a, [NoAlias] float4* b, in DATAREC target, in int ssmd_datacount)
        {
            float* p = target.index00;
            int p_stride = target.row_size >> 2;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f2f1([NoAlias] float4* a, [NoAlias] float4* b, in DATAREC target, in int ssmd_datacount)
        {
            // we could use add_array_f1f2 with -b + a but that requires and extra negation of the data.. 
            // TODO optimize this to run without negate
            negate_f1(b, ssmd_datacount);
            add_array_f1f2(a, b, target, ssmd_datacount); 
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f3f1([NoAlias] float4* a, [NoAlias] float4* b, in DATAREC target, in int ssmd_datacount)
        {
            // TODO optimize this to run without negate
            negate_f1(b, ssmd_datacount);
            add_array_f1f3(a, b, target, ssmd_datacount);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_array_f4f1([NoAlias] float4* a, [NoAlias] float4* b, in DATAREC target, in int ssmd_datacount)
        {
            // TODO optimize this to run without negate
            negate_f1(b, ssmd_datacount);
            add_array_f1f4(a, b, target, ssmd_datacount);
        }
        ...
        #region sub_indexed_fxfx 

        /// <summary>
        /// target[][].x -= source[][].x
        /// </summary>
        static public void sub_indexed_f1f1([NoAlias] in DATAREC target, [NoAlias] DATAREC source, int ssmd_datacount)
        {
            sub_indexed_f1f1(target.data, target.row_size, target.is_aligned, target.index, source.data, source.row_size, source.is_aligned, source.index, ssmd_datacount);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_indexed_f1f1([NoAlias] in DATAREC target, [NoAlias] void** source_indexbuffer, int source_index_rowsize, bool source_is_aligned, int source_index, int ssmd_datacount)
        {
            sub_indexed_f1f1(target.data, target.row_size, target.is_aligned, target.index, source_indexbuffer, source_index_rowsize, source_is_aligned, source_index, ssmd_datacount);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_indexed_f1f1([NoAlias] void** destination_indexbuffer, int destination_index_rowsize, bool destination_is_aligned, int destination_index, [NoAlias] void** source_indexbuffer, int source_index_rowsize, bool source_is_aligned, int source_index, int ssmd_datacount)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_indexed_f1f2(in DATAREC target, in DATAREC source, int ssmd_datacount)
        {
            sub_indexed_f1f2(target.data, target.row_size, target.is_aligned, target.index, source.data, source.row_size, source.is_aligned, source.index, ssmd_datacount);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_indexed_f1f2(in DATAREC destination, [NoAlias] void** source_indexbuffer, int source_index_rowsize, bool source_is_aligned, int source_index, int ssmd_datacount)
        {
            sub_indexed_f1f2(destination.data, destination.row_size, destination.is_aligned, destination.index, source_indexbuffer, source_index_rowsize, source_is_aligned, source_index, ssmd_datacount);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_indexed_f1f2([NoAlias] void** destination_indexbuffer, int destination_index_rowsize, bool destination_is_aligned, int destination_index, [NoAlias] void** source_indexbuffer, int source_index_rowsize, bool source_is_aligned, int source_index, int ssmd_datacount)
        {
            if (destination_is_aligned && source_is_aligned)
            {
                float* s = &((float*)source_indexbuffer[0])[source_index];
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_indexed_f1f3(in DATAREC target, in DATAREC source, int ssmd_datacount)
        {
            sub_indexed_f1f3(target.data, target.row_size, target.is_aligned, target.index, source.data, source.row_size, source.is_aligned, source.index, ssmd_datacount);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_indexed_f1f3(in DATAREC destination, [NoAlias] void** source_indexbuffer, int source_index_rowsize, bool source_is_aligned, int source_index, int ssmd_datacount)
        {
            sub_indexed_f1f3(destination.data, destination.row_size, destination.is_aligned, destination.index, source_indexbuffer, source_index_rowsize, source_is_aligned, source_index, ssmd_datacount);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_indexed_f1f3([NoAlias] void** destination_indexbuffer, int destination_index_rowsize, bool destination_is_aligned, int destination_index, [NoAlias] void** source_indexbuffer, int source_index_rowsize, bool source_is_aligned, int source_index, int ssmd_datacount)
        {
            if (destination_is_aligned && source_is_aligned)
            {
                float* s = &((float*)source_indexbuffer[0])[source_index];
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_indexed_f1f4(in DATAREC target, in DATAREC source, int ssmd_datacount)
        {
            sub_indexed_f1f4(target.data, target.row_size, target.is_aligned, target.index, source.data, source.row_size, source.is_aligned, source.index, ssmd_datacount);
        }
        ...
        /// </summary>                                                       
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_indexed_f1f4(in DATAREC destination, [NoAlias] void** source_indexbuffer, int source_index_rowsize, bool source_is_aligned, int source_index, int ssmd_datacount)
        {
            sub_indexed_f1f4(destination.data, destination.row_size, destination.is_aligned, destination.index, source_indexbuffer, source_index_rowsize, source_is_aligned, source_index, ssmd_datacount);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static public void sub_indexed_f1f4([NoAlias] void** destination_indexbuffer, int destination_index_rowsize, bool destination_is_aligned, int destination_index, [NoAlias] void** source_indexbuffer, int source_index_rowsize, bool source_is_aligned, int source_index, int ssmd_datacount)
        {
            if (destination_is_aligned && source_is_aligned)
            {
                float* s = &((float*)source_indexbuffer[0])[source_index];
